...
/// </summary>
public class TransferReversal : IHasId, IHasCurrency, IHasCreated, IHasUpdated, IHasDescription, IHasMetadata, IHasWorkspace, IHasLive, IHasEtag
{
    /// <inheritdoc/>
    ...
    /// <summary>
    /// Details on the transfer reversal error.
