...
/// </summary>
public class MessageCreateOptionsSchedule
{
    /// <summary>
    ...
    /// <summary>
    /// Convert a <see cref="DateTimeOffset"/> to a <see cref="MessageCreateOptionsSchedule"/>.
    /// </summary>
    /// <param name="time">Value for <see cref="Time"/></param>
    public static implicit operator MessageCreateOptionsSchedule(DateTimeOffset time) => new() { Time = time, };

    /// <summary>
    /// Convert a <see cref="string"/> to a <see cref="MessageCreateOptionsSchedule"/>.
    /// </summary>
    /// <param name="delay">Value for <see cref="Delay"/></param>
    public static implicit operator MessageCreateOptionsSchedule(string delay) => new() { Delay = delay, };
}
