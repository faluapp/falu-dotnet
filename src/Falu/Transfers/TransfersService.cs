...
namespace Falu.Transfers
{
    ...
    public class TransfersService : BaseService
    {
                                                                              ...
                                                                              CancellationToken cancellationToken = default)
        {
            ...
            return await GetAsJsonAsync<List<Transfer>>(uri, requestOptions, cancellationToken);
        }
                                                                       ...
                                                                       CancellationToken cancellationToken = default)
        {
            ...
            return await GetAsJsonAsync<Transfer>(uri, options, cancellationToken);
        }
                                                                          ...
                                                                          CancellationToken cancellationToken = default)
        {
            ...
            return await PostAsJsonAsync<Transfer>(uri, transfer, options, cancellationToken);
        }
                                                                          ...
                                                                          CancellationToken cancellationToken = default)
        {
            ...
            var uri = new Uri(BaseAddress, $"/v1/transfers/{id}");
            return await PatchAsJsonAsync<Transfer>(uri, patch, options, cancellationToken);
        }
    }
}
